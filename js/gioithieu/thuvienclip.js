/*mắt xem, đánh giá video*/

document.addEventListener('DOMContentLoaded', function () {
    // Lấy số lần click từ Local Storage nếu có
    let videoClickCounts = JSON.parse(localStorage.getItem('videoClickCounts')) || {};
                        ...
                        if (event.data === YT.PlayerState.PLAYING) {
                            setTimeout(() => {
                                if (players[iframeId].getPlayerState() === YT.PlayerState.PLAYING) {
                                    ...
                                    videoClickCounts[videoId] = (videoClickCounts[videoId] || 0) + 1;
    ...
    // Cập nhật số lượt xem cho từng video
